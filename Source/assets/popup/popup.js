	...
	function displayEvents(events) {
		...
		[installed, orgasm, milestone].filter(Boolean).sort(function(a, b) {
			...
			if (e.type === 'installed') {
				...
				type = 'milestone';
				var msV = milestones.name(e.value.stage, e.value.index);
				if(msV === '30 seconds' || msV === '60 seconds' || msV === '2 minutes' || msV === '5 minutes' || msV === '15 minutes' || msV === '30 minutes' || msV === '45 minutes' || msV === '1 hour' || msV === '4 hours' || msV === '8 hours' || msV === '16 hours' || msV === '24 hours' || msV === '36 hours') {
					$img.attr('src', '../img/silk/asterisk_yellow.png');
				} else if(msV === '2 days' || msV === '5 days' || msV === '10 days' || msV === '14 days' || msV === '21 days') {
					$img.attr('src', '../img/silk/flag_yellow.png');
				} else if(msV === '30 days' || msV === '45 days') {
					$img.attr('src', '../img/silk/award_star_bronze_2.png');
				} else if(msV === '60 days' || msV === '75 days') {
					$img.attr('src', '../img/silk/award_star_silver_2.png');
				} else if(msV === '90 days' || msV === '120 days') {
					$img.attr('src', '../img/silk/award_star_gold_2.png');
				} else if(msV === '180 days') {
					$img.attr('src', '../img/silk/medal_bronze_2.png');
				} else if(msV === '270 days') {
					$img.attr('src', '../img/silk/medal_silver_2.png');
				} else {
					$img.attr('src', '../img/silk/medal_gold_2.png');
				}
